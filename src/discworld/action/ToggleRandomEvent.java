...
public class ToggleRandomEvent implements Action {
	...
	public ToggleRandomEvent(String name) {
		this.name = name;
	}
	...
	public void toggleAction(ActionParameters params) {
		...
		case FLOOD:
			...
			// Areas rolled that are adjacent to the river are affected by
			// flood.
		...
		case MURDERS:
			...
			// all players have rolled the die once. If you roll an area and
			// only
